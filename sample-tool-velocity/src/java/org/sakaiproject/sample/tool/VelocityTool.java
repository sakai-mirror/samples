...
/**
 * <p>
 * VelocityTool is a Simple Velocity-based Tool
 * </p>
 */
public class VelocityTool extends VelocityPortletPaneledAction
{
	private static Log M_log = LogFactory.getLog(VelocityTool.class);
